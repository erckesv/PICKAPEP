        ...
        try:
            ...
            if pymol_path:
                ...
                try:
                    ...
                    pymol_path = pymol_path + "/Contents/MacOS/PyMOL"
                    subprocess.run([pymol_path, sdf_path])
                    open_pymol = False
            else:
                raise Exception
...
def userinput1(
    ...
    linseq_entry = ttk.Combobox(linseq_frame, values=default_options, width=40)
...
def userinput2(
    ...
    def click_savejpg_button():
        ...
        if save_jpg_path:
            ...
            text_width = current_peptide_draw.textlength(
    ...
    win3_overview_frame.grid(
        row=1, column=0, sticky="news", padx=(20, 10), pady=(10, 10)
    )
    ...
    curr_cycl_listbox = tk.Listbox(curr_cycl_frame, height=4, width=35)
    ...
    curr_mod_listbox = tk.Listbox(curr_mod_frame, height=4, width=35)
    ...
    win4_detail_frame.grid(row=1, column=1, sticky="news", padx=(10, 20), pady=(10, 10))
    ...
    for i, row in df_details.iterrows():
        ...
        if row["Info"] == "Chemical Formula":
            ...
            detail_text_label.tag_configure(
                "subscript", offset=-1, font=("Segoe UI", 9, "normal")
            )
        elif detail_text[5] == "+":
            detail_text_label.tag_add("superscript", f"1.{5}", f"1.{6}")
            detail_text_label.tag_configure(
                "superscript", offset=4, font=("Segoe UI", 8, "normal")
            )
        elif detail_text[7] == "+":
...
def userinput2_cycl(
    ...
    button_back = tk.Button(
        button_frame, text="Back", highlightbackground = "#d9d9d9", command=click_close_button, width=8
    )
...
# Mac
# pyinstaller --onefile --noconsole --add-data="Python_AminoAcids.csv:." --add-data="Python_ModReactions.csv:." --add-data="Python_CyclReactions.csv:." --add-data="Python_TerminalMod.csv:." --add-data="dict_default.pkl:." --add-data="Teriyaki.png:." --add-data="Teriyaki_Easteregg.png:." --add-data="Helpbutton_small.png:." --add-data="Infobutton_small.png:." --add-data="HelpSheet_Userinput1.png:." --add-data="HelpSheet_Userinput1_aminoacids.png:." --add-data="HelpSheet_Userinput1_multiplepepcalc.png:." --add-data="HelpSheet_Userinput2.png:." --add-data="HelpSheet_Userinput2_cycl.png:." --add-data="HelpSheet_Userinput2_mod.png:." --add-data="HelpSheet_Userinput3.png:." --add-data="pymol_path.txt:." --add-data="molecule.sdf:." --icon="Teriyaki.ico" --hidden-import="PIL._tkinter_finder" --hidden-import="openpyxl.cell._writer" PICKAPEP_mac.py
